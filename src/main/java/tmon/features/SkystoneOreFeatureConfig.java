...
public class SkystoneOreFeatureConfig implements FeatureConfig {
	public final int size;
	public final BlockState state;

	public SkystoneOreFeatureConfig(BlockState state, int size) {
		this.size = size;
		this.state = state;
	}
	...
	public static SkystoneOreFeatureConfig deserialize(Dynamic<?> dynamic) {
		...
		return new SkystoneOreFeatureConfig(state, size);
	}
